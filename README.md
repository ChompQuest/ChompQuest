...
This repository was forked from [mern-stack-example]([https://github.com/mongodb-developer/mern-stack-example]) which is based on this [MongoDB MERN tutorial]([https://github.com/mongodb-developer/mern-stack-example])
