...
interface ProfilePictureNutritionGoalsProps {
  onLogout: () => void;
}

const ProfilePictureNutritionGoals: React.FC<ProfilePictureNutritionGoalsProps> = ({ onLogout }) => {
...
export default ProfilePictureNutritionGoals; 